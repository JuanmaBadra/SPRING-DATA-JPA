...
class CustomerRepositoryTest {
   ...
   @Test
    ...
    public void getCustomerByEmailAddress(){
        Customer customer = customerRepository.getCustomerByEmailAddress("carlo@gmail.com");
        System.out.println("customer = " + customer);
    }

    @Test
    public void getCustomerFirstNameByEmailAddress(){
        String firstName = customerRepository.getCustomerFirstNameByEmailAddress("carlo@gmail.com");
        System.out.println("firstName = " + firstName);
    }

    @Test
    public void getCustomerByEmailAddressNative(){
        Customer customer = customerRepository.getCustomerByEmailAddressNative("carlo@gmail.com");
        System.out.println("customer = " + customer);
    }

    @Test
    public void getCustomerByEmailAddressNativeNamed(){
        Customer customer = customerRepository.getCustomerByEmailAddressNativeNamed("g@gmail.com");
        System.out.println("customer = " + customer);
    }
